...
module.exports = function(RED) {
	...
	*/
	...
	var HAT = (function(){
        ...
        var cmd = __dirname+"/automationhatlink.r1";
        var hat = null;
        var allowExit = false;
	...
	RED.nodes.createNode(this,config);
        ...
        node.on("close", function(done) {
                LogTrace("Node closing down, sending exit command to python script...");
		done();
        });
    }

    RED.nodes.registerType("rpi-automationhat r1",AutomationhatOut);
}
